...
pipewire, alsa (alsa-utils package), fontawesome (fonts-font-awesome package) for the speaker symbols
...
```
Usage: volume-pipewire [-S] [-F format] [-f format] [-p] [-a] [-H symb] [-M symb]
